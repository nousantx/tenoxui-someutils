/**
 * Function to generate colors css value from an array of color shade.
 */
...
export function createColors(colors: Colors, prefix: string, selectedColors?: string[]) {
...
export function createRGBColors(colors: Colors, prefix: string, selectedColors?: string[]) {
  const shadeMapping = [50, 100, 200, 300, 400, 500, 600, 700, 800, 900, 950]
  const colorObject: { [className: string]: string } = {}
